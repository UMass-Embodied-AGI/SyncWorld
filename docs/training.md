...
The exported safetensors land at `$RUN_DIR/model`. See [Prepare the checkpoint](../README.md#1-prepare-the-checkpoint) for converting them back to DCP, which is the format the evaluation script consumes.
